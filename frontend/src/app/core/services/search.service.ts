...
import { SorintgDirections } from '../models/enums/sorting-directions';
...
export class SearchService {
  ...
  getSearchResults(query: string, sortingType: SortingTypes, sortingDirection: SorintgDirections,
