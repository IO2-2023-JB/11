...
namespace YouTubeV2.Api.Tests.CommentControllerTests
{
    ...
    public class GetCommentsAsyncTests
    {
        ...
        private string _videoAuthorId = null!;
        ...
        private static Comment _comment1 = new()
        {
        ...
        private static Comment _comment2 = new()
        {
        ...
        public async Task Initialize()
        {
            ...
            await _webApplicationFactory.DoWithinScope<UserManager<User>>(
              async userManager =>
              {
                  ...
                  _videoAuthorId = await userManager.GetUserIdAsync(_videoAuthor);
              });
